...
def check_walker_file(
    job, filename, walker_dirs=["WALKER0", "WALKER1", "WALKER2", "WALKER3"]
):
    walkers = []
...
def reweight_walker_trajectories(
    job, plumed_file, kt, gro_file="npt_new.gro", xtc_file="npt_new.xtc"
):
