...
def main():
    ...
    # Load trajectory
    traj = md.load(["sim0/npt_new.whole.xtc", "sim1/npt_new.whole.xtc", "sim2/npt_new.whole.xtc", "sim3/npt_new.whole.xtc",], top = "sim0/berendsen_npt.gro")
    ...
    min_sample_values = np.linspace(0.005 * total_frames, 0.25 * total_frames, n_min_samples, dtype = int)
